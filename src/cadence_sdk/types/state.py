...
class PluginContext(TypedDict, total=False):
    ...
    finalizer_output: Optional[Dict[str, Any]]
    tools_used: List[str]
...
class StateHelpers:
    ...
    def get_plugin_context(state: AgentState) -> PluginContext:
        ...
        return {
            ...
            PluginContextFields.FINALIZER_OUTPUT: context.get(PluginContextFields.FINALIZER_OUTPUT),
            ...
            **{
                ...
                not in {
                    ...
                    PluginContextFields.FINALIZER_OUTPUT,
    ...
    def safe_get_agent_hops(state: AgentState) -> int:
        ...
        return max(0, hops)  # Ensure non-negative
