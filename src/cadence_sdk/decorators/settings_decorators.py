...
def _validate_settings_schema(settings_list: List[Dict[str, Any]]) -> None:
    ...
    for i, setting in enumerate(settings_list):
        ...
        _validate_setting_type(setting_type, key, valid_types)
...
def _validate_setting_type(setting_type: str, key: str, valid_types: set) -> None:
